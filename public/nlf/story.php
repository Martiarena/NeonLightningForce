...
<body>
	<div class="responsive-back">
		<div class="clouds">
			<div class="luna">
				<div class="body-website interior-pagina story">
					<div id="contenedor">
						<header>
							<div class="logo">
					...
					<div id="contenedor">
						<div class="text-container border-text-interior">
                            <?php if ($cod_idioma==1){?>
							<div class="text-back">
								<div class="titular"><img src="img/story-beat-em-up-openbor-indie-game.gif" /></div>
								<p>The year is 2044. After the events of World War III, the United States and European Union are no more, so utterly devastated they were which paralyze world trade. The power vacuum in Northern America gave rise to the "Pacific Union", with Neopolis as it's capital in South America.</p>
                            ...
                            <?php }else{ ?>
							<div class="text-back">
								<div class="titular"><img src="img/historia-beat-em-up-openbor-indie-game.gif" /></div>
								<p>A&ntilde;o 2044, Tras la Tercera guerra mundial los pa&iacute;ses del norte han quedado devastados paralizando el comercio mundial. Estados Unidos y la Uni&oacute;n Europea no existen m&aacute;s cediendo ante una nueva potencia La Uni&oacute;n del Pac&iacute;fico y su capital Ne&oacute;polis en Sudam&eacute;rica.</p>
